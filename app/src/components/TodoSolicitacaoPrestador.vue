<template>
  ...
  <div class="accepted-requests-section" v-if="acceptedRequests.length > 0">
    ...
    <div class="accepted-requests-list">
      <ul>
        <li v-for="request in acceptedRequests" :key="request.id" class="accepted-request-item">
...
.solicitacoes-container {
  ...
  margin-top: 90px;
  display: flex;
  /* Ativa o Flexbox para centralizar o conteúdo */
...
.solicitacoes-content {
  display: flex;
  /* Ativa o Flexbox para alinhar ícone e título */
  align-items: center;
  /* Centraliza verticalmente */
}
...
.info-details p {
  margin: 5px 0;
  /* Margem entre as linhas */
}

/* Estilo do grupo de botões */
.button-group {
  display: flex;
  /* Ativa o Flexbox para alinhar os botões */
  justify-content: space-between;
  /* Espaçamento entre os botões */
  margin-top: 20px;
  /* Espaço acima dos botões */
  width: 100%;
  /* Para ocupar toda a largura do quadrado */
}
...
.decline-button {
  ...
  /* Cor de fundo do botão recusar */
  color: #ffffff;
  /* Cor do texto do botão recusar */
}
...
.accepted-requests-section {
  margin: 20px;
  /* Margem da seção de solicitações aceitas */
}
...
.request-content {
  display: flex;
  /* Utiliza flexbox para alinhar os itens na linha */
  gap: 10px;
